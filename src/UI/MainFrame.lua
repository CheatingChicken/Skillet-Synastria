...
function Skillet:CreateTradeSkillWindow()
    ...
    SkilletEquipmentOnlyRecipesText:SetText(L["Equipment only"])
...
function Skillet:internal_UpdateTradeSkillWindow()
    ...
    SkilletEquipmentOnlyRecipes:SetChecked(self:GetTradeSkillOption(self.currentTrade, "equipmentonly"))
...
function Skillet:UpdateDetailsWindow(skill_index)
    ...
    -- Synastria: Use resource bank count for slider max value
    local maxCraftable = s.numcraftablewresbank or s.numcraftablewbank
    SkilletCreateCountSlider:SetMinMaxValues(1, max(20, maxCraftable));
