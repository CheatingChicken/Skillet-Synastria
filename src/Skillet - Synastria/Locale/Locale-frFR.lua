...
L:RegisterTranslations("frFR", function()
    return {
        ...
        "Peut être créé à partir de réactifs dans votre inventaire et votre banque",
        ["can be created from reagents on all characters"]          =
        "Peut être créé à partir de réactifs sur tous vos personnages",
        ...
        ["VENDORAUTOBUYDESC"]                                       =
        "Permet d'acheter automatiquement les réactifs nécessaires a vos crafts en attente si le marchand les propose.",
        ...
        "Si l'objet à créer a un niveau minimum requis, ce niveau sera affiché a gauche de la recette",
