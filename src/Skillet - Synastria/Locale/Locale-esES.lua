...
L:RegisterTranslations("esES", function()
    return {
        ...
        "puede ser creado con los reactivos de tu inventario y banco",
        ...
        ["VENDORBUYBUTTONDESC"]                                     =
        "Muestra un botón cuando hable con los vendedores que le permitirá ver los reactivos necesarios para todas las recetas en cola.",
        ["VENDORAUTOBUYNAME"]                                       = "Automáticamente comprar los reactivos",
        ["VENDORAUTOBUYDESC"]                                       =
        "Si tiene recetas en cola y habla con un vendedor que vende algo necesario para las recetas, se adquiere automáticamente.",
        ...
        "Mostrar un tooltip detallado cuando se cierne sobre recetas en el panel izquierdo",
        ["LINKCRAFTABLEREAGENTSNAME"]                               = "Hacer reactivos clickeables",
        ["LINKCRAFTABLEREAGENTSDESC"]                               =
        "Si puedes crear un reactivo necesario para la receta actual, clickenado el reactivo le llevará a su receta.",
        ["QUEUECRAFTABLEREAGENTSNAME"]                              = "Encolar reactivos fabricables",
        ["QUEUECRAFTABLEREAGENTSDESC"]                              =
        "Si puedes crear un reactivo necesario para la receta actual, y no tienes suficientes, entonces estos reactivos serán añadidos a la cola",
        ["DISPLAYSHOPPINGLISTATBANKNAME"]                           = "Mostrar Lista de la Compra en los Bancos",
        ["DISPLAYSHOPPINGLISTATBANKDESC"]                           =
        "Mostrar una Lista de la Compra de los elementos que son necesarios para fabricar recetas encoladas pero que no están en tus bolsas",
        ...
        "Si el elemento fabricado requiere un nivel mínimo para utilizar, este nivel será mostrado con la receta",
        ...
        "Cuando se calcula y se muestra contador de elementos fabricables, incluir elementos de tu banco y de tus otros caracteres.",
        ["ENHANCHEDRECIPEDISPLAYNAME"]                              = "Mostrar la dificultad de la receta como texto",
        ["ENHANCHEDRECIPEDISPLAYDESC"]                              =
        "Cuando activo, nombres de las recetas tendrán uno o más caracteres '+' añadido a su nombre para indicar la dificultad de la receta.",
        ["SHOWCRAFTCOUNTSNAME"]                                     = "Mostrar Contador Fabricación",
        ["SHOWCRAFTCOUNTSDESC"]                                     =
        "Mostrar el número de veces que se puede elaborar una receta, no el número total de elementos elaborables",
