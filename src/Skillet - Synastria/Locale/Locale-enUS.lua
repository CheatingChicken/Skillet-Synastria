...
L:RegisterTranslations("enUS", function()
    return {
        ...
        ["resbank"]                                                 = true, -- "reagents in resource bank" - Synastria
        ...
        ["can be created including Resource Bank"]                  = true, -- Synastria
        ...
        ["VENDORBUYBUTTONDESC"]                                     =
        "Display a button when talking to vendors that will allow you to be the needed reagents for all queued recipes.",
        ["VENDORAUTOBUYNAME"]                                       = "Automatically buy reagents",
        ["VENDORAUTOBUYDESC"]                                       =
        "If you have queued recipes and talk to a vendor that sells something needed for those reicpes, it will be automatically purchased.",
        ...
        "Displays a detailed tooltip when hovering over recipes in the left hand panel",
        ["LINKCRAFTABLEREAGENTSNAME"]                               = "Make reagents clickable",
        ["LINKCRAFTABLEREAGENTSDESC"]                               =
        "If you can create a reagent needed for the current recipe, clicking the reagent will take you to its recipe.",
        ["QUEUECRAFTABLEREAGENTSNAME"]                              = "Queue craftable reagents",
        ["QUEUECRAFTABLEREAGENTSDESC"]                              =
        "If you can create a reagent needed for the current recipe, and don't have enough, then that reagent will be added to the queue",
        ["DISPLAYSHOPPINGLISTATBANKNAME"]                           = "Display shopping list at banks",
        ["DISPLAYSHOPPINGLISTATBANKDESC"]                           =
        "Display a shopping list of the items that are needed to craft queued recipes but are not in your bags",
        ...
        "If the item to be crafted requires a minimum level to use, that level will be displayed along with the recipe",
        ["Transparency"]                                            = true,
        ...
        "When calculating and displaying craftable itemn counts, include items from your bank and from your other characters",
        ["ENHANCHEDRECIPEDISPLAYNAME"]                              = "Show recipe difficulty as text",
        ["ENHANCHEDRECIPEDISPLAYDESC"]                              =
        "When enabled, recipe names will have one or more '+' characters appeneded to their name to inidcate the difficulty of the recipe.",
        ["SHOWCRAFTCOUNTSNAME"]                                     = "Show craftable counts",
        ["SHOWCRAFTCOUNTSDESC"]                                     =
        "Show the number of times you can craft a recipe, not the total number of items producable",
