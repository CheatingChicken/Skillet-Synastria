...
L:RegisterTranslations("ruRU", function()
	return {
		...
		["can be created from reagents in your inventory and bank"] =
		"может быть создан из реагентов в вашем инвентаре и банке",
		...
		["VENDORBUYBUTTONDESC"]                                     =
		"Отображать кнопку при разговоре с торговцем, это позволит вам осмотреть все нужные реагенты для всех ваших рецептах в очереди.",
		["VENDORAUTOBUYNAME"]                                       = "Автоматически купить реагенты",
		["VENDORAUTOBUYDESC"]                                       =
		"Если у вас в очереди есть рецепт/вещи то во время разговора с тогровцем который продаёт что нибудь нужное для вашего рецепта, оно будет куплено автоматически.",
		...
		["SHOWDETAILEDRECIPETOOLTIPDESC"]                           =
		"Отображать детальную подсказку при наведении курсора мыши на рецепт в левой части окна",
		["LINKCRAFTABLEREAGENTSNAME"]                               = "Сделать реагенты кликабельными",
		["LINKCRAFTABLEREAGENTSDESC"]                               =
		"Если вы можете создать реагент, необходимый для текущего рецепта, кликнув по реагент вы перейдёте на его рецепт.",
		["QUEUECRAFTABLEREAGENTSNAME"]                              = "В очередь создаваемые реагенты",
		["QUEUECRAFTABLEREAGENTSDESC"]                              =
		"Если вы можете создать реагент, необходимый для текущего рецепта, и у вас из не хватает, то данный реагент будет добавлен в очередь.",
		["DISPLAYSHOPPINGLISTATBANKNAME"]                           = "Отображать список закупок в банке",
		["DISPLAYSHOPPINGLISTATBANKDESC"]                           =
		"Отображать список закупок вещей которые нужны для создания рецепта находящегося в очереди, вещей которых нет в ваших сумках.",
		["DISPLAYSGOPPINGLISTATAUCTIONNAME"]                        = "Отображать список закупок на аукционе",
		["DISPLAYSGOPPINGLISTATAUCTIONDESC"]                        =
		"Отображать список закупок вещей которые нужны для создания рецепта находящегося в очереди, вещей которых нет в ваших сумках.",

		["Appearance"]                                              = "Внешний вид",
		["APPEARANCEDESC"]                                          = "Настройки внешнего вида.",
		["DISPLAYREQUIREDLEVELNAME"]                                = "Отображать требуемый уровень",
		["DISPLAYREQUIREDLEVELDESC"]                                =
		"Если предмет для создания требует определённый уровень умения, то этот уровень будет отображаться вместе с рецептом.",
		...
		["SHOWBANKALTCOUNTSDESC"]                                   =
		"Когда подсчитывается и отображается число создаваемых предметов, в подсчет предметов включается содержимое банка и с инвентаря других ваших персонажей.",
		["ENHANCHEDRECIPEDISPLAYNAME"]                              = "Отображать сложность рецепта текстом",
		["ENHANCHEDRECIPEDISPLAYDESC"]                              =
		"Если включено, то к названию рецепта будет добавлен символ '+', в зависимости от уровня сложности их количество будет увеличиваться тем самым указания на сложность рецепта.",
		["SHOWCRAFTCOUNTSNAME"]                                     = "Отображать число создаваемого",
		["SHOWCRAFTCOUNTSDESC"]                                     =
		"Показывать сколько раз вы можете создать вещь, а не общее число производимых предметов",
		...
		["SHOWCRAFTERSTOOLTIPDESC"]                                 =
		"Отображает в подсказке предмета, альтернативного персонажа который может создать тот или иной предмет",
	}
end)
