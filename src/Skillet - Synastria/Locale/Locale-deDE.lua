...
L:RegisterTranslations("deDE", function()
    return {
        ...
        "kann mit den Reagenzien in deinem Inventar und der Bank erstellt werden",
        ["can be created from reagents on all characters"]          =
        "kann mit den Reagenzien auf allen Charakteren erstellt werden",
        ...
        ["VENDORBUYBUTTONDESC"]                                     =
        "Zeige einen Button bei Händlern die, die benötigten Reagenzien für Rezepte in der Warteschlange haben.",
        ["VENDORAUTOBUYNAME"]                                       = "Reagenzien automatisch kaufen",
        ["VENDORAUTOBUYDESC"]                                       =
        "Wenn du Rezepte in der Warteschlange hast und mit einem Händler sprichst der etwas verkauft was für die Rezepte benötigt, wird es automatisch gekauft.",
        ...
        "Zeigt einen detaillierten Tooltip wenn man über die Rezepte auf der linken Seite des Panels fährt",
        ["LINKCRAFTABLEREAGENTSNAME"]                               = "Mache Reagenzien Klickbar",
        ["LINKCRAFTABLEREAGENTSDESC"]                               =
        "Wenn du ein Reagenz für das aktuelle Rezept herstellen kannst wird ein Klick auf das Reagenz zum entsprechenden Rezept bringen.",
        ["QUEUECRAFTABLEREAGENTSNAME"]                              = "Füge herstellbare Reagenzien zur Warteschlange hinzu",
        ["QUEUECRAFTABLEREAGENTSDESC"]                              =
        "Wenn du ein Reagenz für das aktuelle Rezept herstellen kannst und nicht genug Reagenzien hast, wird das Reagenz zur Warteschlange hinzugefügt",
        ["DISPLAYSHOPPINGLISTATBANKNAME"]                           = "Zeige Einkaufsliste in der Bank",
        ["DISPLAYSHOPPINGLISTATBANKDESC"]                           =
        "Zeigt eine Einkaufsliste, die die Items zeigt die benötigt werden um die Rezepte in der Warteschlange herzustellen, aber nicht in deinen Taschen sind",
        ...
        "Wenn das hergestellte Item ein Level-Minimum erfordert um es zu benutzen, wird das Level im Rezept angezeigt",
        ...
        ["Library"]                                                 = "Bibliothek",
        ["SUPPORTEDADDONSDESC"]                                     =
        "Unterstützte Addons die Dazu benutzt werden könnten oder benutzt werden um das Inventar aufzuzeichnen.",
